...
// Include header layout (this performs authentication checks automatically)
require_once 'includes/header.php';

// Prepare metrics placeholders
$totalDonors = 0;
$totalRequests = 0;
$pendingRequests = 0;
$totalUnitsInStock = 0;
...
try {
    ...
    // Sort logically by standard blood group listings
    ...
    $recentRequestsStmt = $pdo->query("SELECT * FROM blood_requests ORDER BY FIELD(status, 'Pending', 'Approved', 'Fulfilled', 'Cancelled'), required_date ASC LIMIT 4");
...
<div class="row g-4 mb-4">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="metrics-card">
            ...
            <div class="metrics-card-icon crimson">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="metrics-card">
            ...
            <div class="metrics-card-icon emerald">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="metrics-card">
            ...
            <div class="metrics-card-icon amber">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="metrics-card">
            ...
            <div class="metrics-card-icon blue">
...
<div class="row g-4">
    <!-- Visual Analytics: Stock Levels Chart -->
    <div class="col-xl-7">
    ...
    <!-- Right Side Panel: Urgent Pending Requests -->
    <div class="col-xl-5">
        <div class="premium-card h-100">
            <div class="premium-card-header">
                <h3 class="premium-card-title">
            ...
            <div class="premium-card-body p-0">
                ...
                <?php if (empty($recentRequests)): ?>
                    <div class="p-5 text-center text-muted">
                        ...
                        <p class="mb-0">No hospital requests recorded in database.</p>
                    </div>
                <?php else: ?>
                            ...
                            <div class="list-group-item bg-transparent border-0 border-bottom border-secondary-subtle p-3 transition-bg-hover">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div style="font-size: 13px; color: var(--text-muted);">
                                        <div><i class="fa-solid fa-hospital me-1" style="font-size: 11px;"></i> <?php echo htmlspecialchars($request['hospital_name']); ?></div>
                                        <div><i class="fa-regular fa-calendar-days me-1" style="font-size: 11px;"></i> Needed: <strong><?php echo date('M d, Y', strtotime($request['required_date'])); ?></strong></div>
                                    </div>
                                    <div class="d-flex align-items-center gap-2">
                                        <?php 
                                            ...
                                            if ($request['status'] === 'Cancelled') $statusClass = 'badge-status-cancelled';
                                        ?>
                                        <span class="badge-status <?php echo $statusClass; ?>">
                                            <?php echo htmlspecialchars($request['status']); ?>
                                        </span>
                                        <a href="request-edit.php?id=<?php echo $request['id']; ?>" class="btn-premium-action edit-btn" title="Process request">
...
<!-- Dynamic chart bootstrapping inside footer scripts hooks -->
<?php 
// Format PHP arrays into JSON for the javascript loader
$jsGroups = json_encode($stockGroups);
$jsUnits = json_encode($stockUnits);
?>
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Feed database values directly into premium visual reporter
        initBloodStockChart(<?php echo $jsGroups; ?>, <?php echo $jsUnits; ?>);
    });
</script>

<?php
// Include footer layout to close page wrappers and scripts
